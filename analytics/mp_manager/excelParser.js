...
module.exports = (campaign_id) => {
	...
	const presented_ids = xlsx.parse(`./files/${campaign_id}_presented.xlsx`)[0]['data'][0]
...
//    console.log(resultSheet)
    fs.writeFileSync(`./files/${campaign_id}.xlsx`, xlsx.build([{ name: 'Аналитика', data: resultSheet }]));
//    clearDownloadsFolder()
}
